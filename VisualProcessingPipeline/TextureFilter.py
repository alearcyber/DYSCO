"""Filter subclass for applying textures"""

#TODO
# - Work on the filter subclass thing
# - probably need a function that applies the filters in the first place.
# - Need to make static instances of the filters, I think?
# - Borrow stuff from old class for textures
# - also need a downsampling filter
...
def texture_features(img):
    ...
    for name, map in TextureFilter.energy_maps:
